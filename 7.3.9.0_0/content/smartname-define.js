! function(e) {
    ...
    366: function(e, t, a) {
        ...
        var c = connect(function(e, t) {
            ...
            return function(e, t) {
            ...
            }(t, React.Component), n(t, [{
                key: "componentWillReceiveProps",
                value: function(e) {
                    "page-content" == e.data.mode && e.data.xpath !== this.state.xpath && weh.rpc.call("selectSmartNameXPath", e.data.ref, e.data.xpath);
                    for (var t = [], a = e.data.domain.split("."), n = 0; n < a.length - 1; n++) t.push(a.slice(n).join("."));
                    var r = t[0];
                    t.indexOf(this.state.domain) >= 0 && (r = this.state.domain);
                    var l = this;
                    this.setState({
                        selected: "",
                ...
                value: function(e) {
                    var t = this;
                    return function(a) {
                        if ("advanced" === e) return t.setState({
                            advanced: a.target.checked
                        });
                        ...
                        switch (e) {
                            ...
                            case "xpath":
                                r.xpath = n;
                                try {
                                    document.evaluate(n, document, null, XPathResult.STRING_TYPE, null), r.xpathClass = "", weh.rpc.call("selectSmartNameXPath", t.props.data.ref, n)
                                } catch (e) {
                                    r.xpathClass = "error", l = !0
                                }
                                break;
                            case "regexp":
                                r.regexp = n;
                                try {
                                    new RegExp(n), r.regexpClass = ""
                                } catch (e) {
                                    r.regexpClass = "error", l = !0
                                }
                                break;
                            case "domain":
                                r.domain = n;
                                break;
                            case "delay":
                                r.delay = n, /^[0-9]+$/.test(n) ? r.delayClass = "" : r.delayClass = "error"
                        }
                        t.setState(r, function() {
                            !l && ["mode", "xpath", "regexp"].indexOf(e) >= 0 && t.evaluate()
                        })
                    }
                }
            }, {
                key: "renderParams",
                value: function() {
                    var e = this.state.domains.map(function(e) {
                    ...
                    return React.createElement("div", {
                    ...
                    }, weh._("smartnamer_domain")), React.createElement("select", {
                        ...
                        value: "obfuscated"
                    }, weh._("smartnamer_get_obfuscated_name")))), this.state.advanced && React.createElement("div", null, React.createElement("div", {
                        className: "form-group row"
                    }, React.createElement("label", {
                ...
                value: function() {
                    ...
                    })))), React.createElement("main", null, this.renderParams()), React.createElement("footer", null, React.createElement("div", {
                    ...
                    }, weh._("advanced"))), React.createElement("div", {
        ...
        render(React.createElement(Provider, {
            ...
            className: "weh-shf"
        }, React.createElement(c, null))), document.getElementById("root")), weh.setPageTitle(weh._("smartname_define"))
    }
});