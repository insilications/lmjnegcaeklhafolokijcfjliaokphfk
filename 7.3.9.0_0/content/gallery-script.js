! function(e) {
            ...
            return t(e, [{
                ...
                value: function() {
                    ...
                    return new Promise(function(i, g) {
                        var a = ++o.replyId;
                        o.debugLevel >= 2 && o.logger.info("rpc #" + a, "call =>", s, t), o.hook({
                            type: "call",
                            callee: r,
                            rid: a,
                            method: s,
    ...
    349: function(e, r, s) {
        ...
        function i(e, r, s) {
            for (var t = document.querySelectorAll(e), i = 0; i < t.length && (0 == s.maxHits || i < s.maxHits); i++) {
                var m = t.item(i),
                    l = null,
                    A = !1;
                switch (r) {
                    case "link":
                        ...
                        break;
                    case "image":
                        m.width && m.height && "image" == r && Math.min(m.width, m.height) >= s.minImgSize && (l = m.getAttribute("src").trim(), A = !0)
                }
                if (A) {
                    ...
                    if (l) {
                        ...
                        var x = "vdh-" + (d = a(window.location.href + "@" + c.join("/") + "@" + f)),
                            h = n[d];
                        if (h || (h = n[d] = {
                                urlsMap: {},
                                urls: [],
                            ...
                            if (m.firstChild && "img" == m.firstChild.nodeName.toLowerCase() && (m = m.firstChild), g(m, h.selectorAttr), h.urlsMap[l] = 1, h.urls.push(l), f) h.extensions[f] ? h.extensions[f]++ : h.extensions[f] = 1
                    } else {
                        var d;
                        e = o(m);
                        g(m, x = "vdh-" + (d = a(window.location.href + "@" + e + "@scrap"))), n[d] = {
                            baseUrl: window.location.href,
                            selectorAttr: x,
                            selector: e,
                            type: r,
                            size: m.offsetWidth + "x" + m.offsetHeight
                        }
                    }
                }
            }
        ...
        function o(e) {
            for (var r = []; e;) {
                ...
                if (e.getAttribute && e.getAttribute("id") && (s += "#" + e.getAttribute("id")), 1 == document.querySelectorAll(r.concat([s]).join(" > ")).length) {
                    r.push(s);
                    break
                }
        ...
        function g(e, r) {
            ...
            (e = document.createElement("div")).setAttribute("style", "width:" + n + "px;height:" + i + "px;top:" + s + "px;left:" + t + "px;"), e.setAttribute("class", "vdh-mask " + r), document.body.appendChild(e)
        }

        function a(e) {
            var r, s, t = 0;
            if (0 == e.length) return t;
            for (r = 0, s = e.length; r < s; r++) t = (t << 5) - t + e.charCodeAt(r), t |= 0;
            return "" + Math.abs(t)
        }
        ...
        var m = _$vdhParams,
            l = [];
        m.extensions.split("|").forEach(function(e) {
            l.push("a[href$='" + e + "']"), l.push("a[href$='" + e.toUpperCase() + "']")
        }), m.scanLinks && i(l.join(","), "link", m), m.scanImages && i("img[src]", "image", m);
        var A = 0;
        for (var c in n) {
            var u = n[c];
            u.urls && u.urls.length < m.minFilesPerGroup ? delete n[c] : A++
        }
        A > 0 && t.rpc.call("galleryGroups", {
                                ...
                                a = {
                                    ...
                                    get(e, a, m) {
                                        ...
                                        if ("function" == typeof l)
                                            if ("function" == typeof i[a]) l = s(e, e[a], i[a]);
                                            else if (t(o, a)) {
                                            let t = r(a, o[a]);
                                            l = s(e, e[a], t)
                                        } else l = l.bind(e);
                                        else {
                                            if ("object" != typeof l || null === l || !t(i, a) && !t(o, a)) return Object.defineProperty(g, a, {
                                                configurable: !0,
                                                enumerable: !0,
                                                get: () => e[a],
                                                set(r) {
                                    ...
                                    set: (e, r, s, t) => (r in g ? g[r] = s : e[r] = s, !0),
