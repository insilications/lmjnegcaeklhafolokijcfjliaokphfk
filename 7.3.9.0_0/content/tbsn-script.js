! function(e) {
    ...
    15: function(e, r, t) {
        ...
        i.uiName = o.panel;
        var g = !o.noprefs;
        i.rpc = t(3), i.rpc.listen({
            close: function() {
                window.close()
            }
        });
        var m = a.runtime.connect({
            name: "weh:" + a.runtime.id + ":" + i.uiName
        });
        i.rpc.setPost(m.postMessage.bind(m)), m.onMessage.addListener(function(e) {
            i.rpc.receive(e, m.postMessage.bind(m))
        }), i.rpc.call("appStarted", {
            uiName: i.uiName,
            usePrefs: g
        }).catch(function(e) {
        ...
        if (g) {
            ...
            var u = {};
            try {
                var A = localStorage.getItem("weh-prefs");
            ...
            l.assign(u), l.on("", {
                ...
                i.rpc.call("prefsSet", e)
            }), c.push(new Promise(function(e, r) {
                i.rpc.call("prefsGetSpecs").then(function(e) {
                    return l.declare(e), i.rpc.call("prefsGetAll")
                }).then(function(r) {
                    l.assign(r), l.forceNotify(!1), e()
                }).catch(r)
            })), i.rpc.listen({
                setPrefs: function(e) {
                    l.assign(e)
        ...
        Promise.all(c).then(function() {
            return i.rpc.call("appReady", {
                uiName: i.uiName
            })
        }).then(function() {
            if (d = !0, p) {
                var e = f;
                f = void 0, p = !1, i.doTrigger(e)
            }
        }).catch(function(e) {
        ...
        var p = !1,
            f = void 0,
            d = !1;
        i.doTrigger = function(e) {
            return i.rpc.call("trigger", i.uiName, e).catch(function() {})
        }, i.trigger = function(e) {
            if (d) return i.doTrigger(e);
            f = e, p = !0
        }, i._ = t(9).getMessage, i.copyToClipboard = function(e, r) {
    ...
    24: function(e, r, t) {
        ...
        i.prototype = {
            notify: function(e, r, t, n) {
                for (var s = this, i = e.split("."), a = [], o = i.length; o >= 0; o--) a.push(i.slice(0, o).join("."));
            ...
            declare: function(e) {
                ...
                Array.isArray(e) || (e = Object.keys(e).map(function(r) {
                    ...
                    "choice" == e.type && (e.choices = (e.choices || []).map(function(r) {
                        ...
                        var i = r.replace(/[^0-9a-zA-Z_]/g, "_");
                        return {
                            value: r,
                            name: s("weh_prefs_" + t + "_option_" + i) || r
                        }
                    }));
                    var i, a = null;
                    r.$specs[e.name] || (i = e.name, void 0 !== r[e.name] && (a = r[e.name]), Object.defineProperty(r, i, {
                        set: function(e) {
                            var t = r.$values[i];
                            t !== e && (r.$values[i] = e, r.notify(i, e, t, !1))
                        },
                        get: function() {
                            return void 0 !== r.$values[i] ? r.$values[i] : r.$specs[i] && r.$specs[i].defaultValue || void 0
                        }
                    }));
                    var g = r.$specs[e.name];
                    r.$specs[e.name] = e, null !== a ? r.$values[e.name] = a : void 0 === r.$values[e.name] && (r.$values[e.name] = e.defaultValue), r.notify(e.name, e, g, !0)
                })
            },
            on: function() {
                var e = "",
                ...
                i && (a.pack = {}, a.old = {}), this.$listeners[e].push(a)
            },
            off: function() {
                var e = "",
                    r = 0;
        ...
        var a = new i,
            o = {};
        for (var g in a) a.hasOwnProperty(g) && (o[g] = !0);
        e.exports = a
    },
    3: function(e, r, t) {
        "use strict";
        ...
        var a = function() {
            ...
            return n(e, [{
                ...
                value: function() {
                    ...
                    if ("function" == typeof o[0] && (e = o.shift()), a.useTarget) {
                        var g = i(o);
                    ...
                    return new Promise(function(i, o) {
                        var g = ++a.replyId;
                        a.debugLevel >= 2 && a.logger.info("rpc #" + g, "call =>", t, n), a.hook({
                            type: "call",
                            callee: r,
                            rid: g,
                            method: t,
                        ...
                        var m = e || a.useTarget && a.posts[r] || a.post;
                        a.useTarget ? m(r, {
                            type: "weh#rpc",
                            _request: g,
                            _method: t,
    ...
    372: function(e, r, t) {
        "use strict";
        var n = t(15).browser;
        window.vdhPostListener || (window.vdhPostListener = function(e) {
            if ("vdhPostRequest" == e.type) return new Promise(function(r, t) {
                var n = new XMLHttpRequest;
                n.onreadystatechange = function() {
                    4 == n.readyState && r(n.responseText)
                }, n.open("POST", e.url + "&_vdh_"), n.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                var s, i = [];
                Object.keys(e.formData).forEach(function(r) {
                    i.push(encodeURIComponent(r) + "=" + encodeURIComponent(e.formData[r]))
                }), s = i.join("&").replace(/%20/g, "+"), n.send(s)
            })
        }, n.runtime.onMessage.addListener(window.vdhPostListener))
    },
    4: function(e, r, t) {
        var n, s, i, a;
        a = function(e) {
                                ...
                                g = {
                                    ...
                                    get(e, g, m) {
                                        ...
                                        if ("function" == typeof c)
                                            if ("function" == typeof i[g]) c = t(e, e[g], i[g]);
                                            else if (n(a, g)) {
                                            let n = r(g, a[g]);
                                            c = t(e, e[g], n)
                                        } else c = c.bind(e);
                                        else {
                                            if ("object" != typeof c || null === c || !n(i, g) && !n(a, g)) return Object.defineProperty(o, g, {
                                                configurable: !0,
                                                enumerable: !0,
                                                get: () => e[g],
                                                set(r) {
        ...
        }, s = [e], void 0 === (i = "function" == typeof(n = a) ? n.apply(r, s) : n) || (e.exports = i)
    },
    9: function(e, r, t) {
        "use strict";
        var n = t(2).browser,
            s = {},
            i = new RegExp("\\$[a-zA-Z]*([0-9]+)\\$", "g");
        ...
        a(), e.exports = {
            getMessage: function(e, r) {
                ...
                var a = s[e];
                return a && a.message.length > 0 ? (Array.isArray(r) || (r = [r]), (a.message || "").replace(i, function(e) {
                    var t = i.exec(e);
