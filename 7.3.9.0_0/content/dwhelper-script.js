! function(e) {
        ...
        var o = function() {
            ...
            return t(e, [{
                ...
                value: function() {
                    ...
                    if ("function" == typeof i[0] && (e = i.shift()), o.useTarget) {
                        var a = g(i);
    ...
    340: function(e, r, s) {
        ...
        window.addEventListener("message", function(e) {
            e.data.fromContent && ("getInApp" == e.data.type && t.rpc.call("getInApp").then(function(e) {
                window.postMessage({
                    fromAddon: !0,
                    type: "getInApp",
                    inApp: e
                }, "*")
            }), "inAppBuy" == e.data.type && t.rpc.call("inAppBuy", e.data.sku).then(function(e) {
                window.postMessage({
                    fromAddon: !0,
                    type: "chrome-hook"
                }, "*")
    ...
    4: function(e, r, s) {
                                ...
                                a = {
                                    ...
                                    get(e, a, m) {
                                        ...
                                        if ("function" == typeof A)
                                            ...
                                            if ("object" != typeof A || null === A || !t(g, a) && !t(o, a)) return Object.defineProperty(i, a, {
                                                configurable: !0,
                                                enumerable: !0,
                                                get: () => e[a],
                                                set(r) {
                                    ...
                                    set: (e, r, s, t) => (r in i ? i[r] = s : e[r] = s, !0),
        ...
        }, n = [e], void 0 === (g = "function" == typeof(t = o) ? t.apply(r, n) : t) || (e.exports = g)
    }
});